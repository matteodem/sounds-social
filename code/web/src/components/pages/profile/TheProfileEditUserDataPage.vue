  ...
  <layout-default>
    ...
    <div slot="main">
      ...
      <pure-modal @close="abortDeleteProcess" v-if="openModalId === 'explain'">
        <div class="pa4">
          <div class="lh-copy">
            <h2 class="tc f2" v-text="$t('What will be permanently deleted?')"></h2>
            ...
            <ul>
              ...
              <li v-text="$t('Your aliases (where you are the only member)')"></li>
      ...
      <pure-modal @close="abortDeleteProcess" v-if="openModalId === 'passphraseExplain'">
        <div class="pa4">
          <div class="lh-copy">
            <h2 class="tc f2" v-text="$t('What will continue being accessible?')"></h2>
      ...
      <pure-modal @close="abortDeleteProcess" v-if="openModalId === 'confirm'">
        <div class="pa4">
          <div class="lh-copy">
            <h2 class="tc f2" v-text="$t('Confirm deletion')"></h2>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteUser () {
        // TODO: delete user through API, log out, display simple window.alert
      },
    },
  }
</script>
